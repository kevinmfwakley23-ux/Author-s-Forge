...
(() => {
  ...
  function ensureStudioExtensions(){if(!isMainStudio())return;if(document.getElementById("art"))loadExtension("image-lab","/forge-image-lab.js");if(document.getElementById("cover"))loadExtension("cover-production","/forge-cover-production.js");loadExtension("story-architecture","/forge-story-architecture.js");loadExtension("chapter-cards","/forge-chapter-cards.js");loadExtension("chapter-card-workflow","/forge-chapter-card-workflow.js");loadExtension("chapter-card-approval","/forge-chapter-card-approval.js");loadExtension("scene-cards","/forge-scene-cards.js");loadExtension("manuscript-import","/forge-manuscript-import.js");loadExtension("ai-gateways","/forge-ai-gateways.js");loadExtension("model-freedom","/forge-model-freedom.js");loadExtension("forge-recipes","/forge-recipes.js");loadExtension("review-room","/forge-review-room.js");loadExtension("provenance","/forge-provenance.js");loadExtension("brand-studio","/forge-brand-studio.js");loadExtension("royal-ui","/forge-royal-ui.js");}
