...
/**
 * Shared governance boundary for state-changing actions across Forge offices.
 * AI may always propose, but it may never directly apply, lock, or override
 * author-owned creative state without explicit author approval. System actors
 * are limited to operational state and cannot silently mutate creative state.
 */
