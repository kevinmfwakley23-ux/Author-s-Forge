...
import type { ProductionFormat, ProductionOptions } from "../domain/manuscript-production";
...
export function createStudioProductionExportRoutes(
  ...
  return async (req, res, url, projectId) => {
    ...
    const artifact = production.render({
      projectId,
      bookId: book.id,
      title: book.title,
      author,
    ...
    const evidence = await vault.save(artifact, options);
