...
const capabilities = [
  ...
  ['Guided Journal Office', [
    ...
    'scripts/guided-journal-browser-acceptance.js',
  ], () => hasTest(/guided-journal/)],
  ['Educational Workbook Office', [
    'src/domain/educational-workbook.ts',
    'src/application/educational-workbook-office.ts',
    'src/application/educational-workbook-production.ts',
    'src/educational-workbook-server.ts',
  ...
  ['Specialized Creation Office', [
    ...
    'src/application/specialized-creation-production-engine.ts',
    'src/specialized-creation-server.ts',
    'public/specialized-creation.html',
    'scripts/specialized-creation-browser-acceptance.js',
    'scripts/specialized-creation-mobile-acceptance.js',
  ], () => hasTest(/specialized-creation/)],
